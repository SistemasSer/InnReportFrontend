...
function CreateEntidad() {
  ...
  const setFormValue = (event: React.ChangeEvent<HTMLInputElement>) => {
    dispatch(
      setData({ ...entidad.data, [event.target.id]: event.target.value })
    );
  };
  ...
  const isValidForm = () => {
    ...
    if (!entidad.data.Descripcion) error.Descripcion = true;
    if (!entidad.data.Departamento) error.Departamento = true;
    if (!entidad.data.Ciudad) error.Ciudad = true;
  ...
  return (
    <div className="block mt-0 w-[calc(1220px)] px-10 py-8 bg-transparent">
      <p style={{ fontSize: 32, padding: 0 }}>Entidad (Crear) </p>

      <hr className="my-8 place-content-baseline border-gray-200 dark:border-gray-700" />

      <div className="gap-6 w-[calc(1200px)] pr-20 pb-7">
        <div className="px-8 py-4 pb-8 bg-gray-100">
          <form
            className="grid grid-cols-2 gap-4"
            onSubmit={(e) =>
              entidad.data.id ? fetchUpdate(e) : fetchCreate(e)
            }
          >
            <div className="mt-4">
            ...
            <div className="mt-4">
              ...
              <input
                ...
                onChange={(e) => setFormValue(e)}
                className={
                  errorForm.RazonSocial ? inputCSS + inputError : inputCSS
                }
              />
              {errorForm.RazonSocial && (
                <p className="mt-1 text-m text-red-400">
                  Este campo es obligatorio
                </p>
              )}
            ...
            <div className="mt-4">
              <label className="mb-2  text-gray-800">Descripción</label>
              <input
                id="Descripcion"
                type="text"
                placeholder="Digita la descripción"
                value={entidad.data.Descripcion}
                onChange={(e) => setFormValue(e)}
                className={
                  errorForm.Descripcion ? inputCSS + inputError : inputCSS
                }
              />
            ...
            <div className="mt-4">
              <label className="mb-2  text-gray-800">Departamento</label>
              <input
                id="Departamento"
                type="text"
                placeholder="Digita el departamento"
                value={entidad.data.Departamento}
                onChange={(e) => setFormValue(e)}
                className={
                  errorForm.Departamento ? inputCSS + inputError : inputCSS
                }
              />
            ...
            <div className="mt-4">
              <label className="mb-2  text-gray-800">Ciudad</label>
              <input
                id="Ciudad"
                type="text"
                placeholder="Digita la ciudad"
                value={entidad.data.Ciudad}
                onChange={(e) => setFormValue(e)}
                className={errorForm.Ciudad ? inputCSS + inputError : inputCSS}
              />
              {errorForm.Ciudad && (
                <p className="mt-1 text-m text-red-400">
                  Este campo es obligatorio
            ...
            <div className="mt-4">
              ...
              <input
                ...
                onChange={(e) => setFormValue(e)}
                className={
                  errorForm.Direccion ? inputCSS + inputError : inputCSS
                }
              />
              {errorForm.Direccion && (
                <p className="mt-1 text-m text-red-400">
            ...
            <div className="mt-4">
              ...
              <input
                ...
                onChange={(e) => setFormValue(e)}
                className={
                  errorForm.Telefono ? inputCSS + inputError : inputCSS
                }
              />
              {errorForm.Telefono && (
                <p className="mt-1 text-m text-red-400">
            ...
            <div className="mt-4">
              <label className="mb-2  text-gray-800">RepresentanteLegal</label>
              <input
